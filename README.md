...
Following, the Top 4 of my projects:
...
- [Project 4: ML Training Pipeline](https://github.com/JuanRugerio/ML-Pipeline) - This modularized pipeline preprocesses data, trains an initial XGBoost model, selects features SHAP based and trains final tuned model with a Bayesian methodology.
